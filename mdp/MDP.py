class MDP(object):
	...
	def getRewards(self, initState,  nextState):
	...
	def probNextStates(self, initState, action):
		...
		if initState != "GOAL" and initState!="OUT":
			if action != "SHOOT":
				...
				# Inside that loop only movement actions are selected
				...
				# Make sure you are inside the grid at all times.
				...
				# Final transitions : 0.85 correct one, 0.05 to all not intended
